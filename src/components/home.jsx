    ...
    <section id="home" className="Hero-page-Container">
      <div className="hero-page">
        ...
        <div className="hero-content">
          <h1>
            Front-end <span className="React--higlight">React</span> Developer
          </h1>
      ...
      <div className="tech-stack-container">
        <div className="tech-stac-header">
          <h2>Tech Stack</h2>
        ...
        <div className="icons-stack">
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="ionicon logo-javascript"
            viewBox="0 0 512 512"
          >
