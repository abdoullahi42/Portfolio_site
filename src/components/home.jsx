...
function Home() {
  return (
    <section id="home" className="w-[90%] mx-auto px-[10px] md:px-[22px] md:pl-[16px] lg:px-[40px] lg:pl-[24px] pt-16">
      <div className="flex flex-col gap-[42px] mt-9 md:mt-8 md:my-6 lg:my-[90px] lg:mb-8 lg:gap-[100px] md:flex-row-reverse md:gap-14">
        ...
        <div className="text-center md:text-left flex flex-col">
          <h1 className="text-[36px] leading-[1.2] mb-6 tracking-[-1.5px] md:text-[56.5px] lg:pt-3">
      ...
      <div className="flex flex-col items-center gap-5 mb-8 md:flex-row md:items-start md:gap-9 md:mb-12 lg:mb-[62px] lg:py-3 lg:px-[15px]">
        <div className="text-center md:text-left">
          <h2 className="text-[30px] border-b border-[rgba(45,46,50,0.5)] pb-1 md:text-[36px] md:border-b-0 md:border-r-2 md:border-[rgba(45,46,50,0.5)] md:pr-2">
            Tech Stack
          </h2>
        </div>
